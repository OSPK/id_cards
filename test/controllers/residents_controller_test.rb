...
class ResidentsControllerTest < ActionController::TestCase
  ...
  test "should create resident" do
    assert_difference('Resident.count') do
      post :create, resident: { address: @resident.address, cnic: @resident.cnic, guardian: @resident.guardian, name: @resident.name, phone: @resident.phone, photo: @resident.photo, thumbprint: @resident.thumbprint }
    end
  ...
  test "should update resident" do
    patch :update, id: @resident, resident: { address: @resident.address, cnic: @resident.cnic, guardian: @resident.guardian, name: @resident.name, phone: @resident.phone, photo: @resident.photo, thumbprint: @resident.thumbprint }
    assert_redirected_to resident_path(assigns(:resident))
  end
